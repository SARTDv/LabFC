package object Datos {
  ...
  val vuelosCurso = List(
    ...
    //Vuelo("COPA", 12355, "CTG", 10, 30, "PTY", 11, 30, 0),
    //Vuelo("AVA", 4321, "CTG", 9, 30, "SMR", 10, 0, 0),
    //Vuelo("AVA", 4355, "CTG", 11, 0, "SMR", 10, 0, 0),
    //Vuelo("AVA", 4321, "SMR", 9, 30, "SMR", 10, 0, 0),
    Vuelo("COPA", 7631, "SMR", 8, 50, "PTY", 11, 50, 0),
    Vuelo("TURKISH", 7799, "CLO", 7, 0, "IST", 14, 0, 3),
    Vuelo("QATAR", 5566, "IST", 23, 0, "SVO", 2, 0, 0)

    //Vuelos de prueba para ItinerarioSalida
    /*
    Vuelo("COPA", 1234, "CTG", 10, 0, "PTY", 11, 30, 0), //+++
    Vuelo("COPA", 1234, "CTG", 11, 50, "PTY", 11, 51, 0),

    Vuelo("AVA", 4355, "CTG", 11, 0, "SMR", 10, 0, 0),
    Vuelo("AVA", 4356, "CTG", 10, 50, "SMR", 8, 50, 0), //+++
    Vuelo("COPA", 7631, "SMR", 8, 50, "PTY", 11, 50, 0),
